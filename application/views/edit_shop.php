...
<script type='text/javascript' src='<?php echo base_url();?>assets/js/jquery.geocomplete.js'></script>
 ...
 if($user_info['role'] == '6'){ 
    ...
    $action = 'site/edit_shop?id='.$_GET["id"];
 }
...
//                                                                google.maps.event.addDomListener(window, 'load', initialize(latlng));
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-8">
                                                    <input type="text" name="email" placeholder="" class="form-control" <?php if($user_info['is_corporate_business_user'] == 1){ echo 'disabled';} ?> value="<?php echo set_value('email',$shop['email']); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-md-8"><button type="submit" name="edit_shop" class="btn btn-default">Submit</button></td>
                                            </tr>
