                  ...
                  <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                  ...
                                  <?php if((is_permission($this->session->userdata['role'], "list_corporate")) == TRUE){ ?>       
                                <a class="btn btn-green" style="float:right" href="<?php echo base_url();?>site/add_corporate">Add Corporate</a>
                                <?php } ?>
                       
                                   
                                <div class="table-responsive">
                                    <form action="<?php echo base_url(); ?>site/list_corporate" method="GET" enctype="multipart/form-data">  
                                    <table class="table table-hover">
                                         <tr><td colspan="5" style="border-top: 0px solid #ddd;">&nbsp;</td></tr>
                                            <tr>
                                                <td style="width: 7%; vertical-align: middle;">Search By :&nbsp;</td>
                                                <td style="width: 35%;"><input type="text" placeholder="Corporate name or email" name="search" id="search" class="form-control" <?php if(isset($search) && !empty($search)){ echo 'value="' . $search . '"';}?>></td>
                                                ...
                                                <td>&nbsp;&nbsp;<button type="submit" name="go" class="btn btn-default">GO</button> <a class="pull-right" href="<?php echo base_url(); ?>site/list_shop">Reset Search</a></td>
                                            </tr>
                                        ...
                                        <tbody>
                                           <?php
                                                    foreach($info as $v){
                                                        ...
                                                        $src=(!empty($v['profile_pic'])) ? base_url()."uploads/user/".$v['profile_pic'] : base_url()."assets/images/shop_def.png";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo date("F j, Y, g:i a",strtotime($v['signup_date'])); ?></td>
                                                             <td>
                                                                 <a class="btn btn-green" href="<?php echo base_url(); ?>site/list_business/?id=<?php echo $v['user_id']; ?>">View Business</a>
                                                                ...
                                                                <a href="<?php echo base_url(); ?>site/edit_corporate_user/?id=<?php echo $v['user_id']; ?>"><img src="<?php echo base_url(); ?>assets/images/edit.png" /></a>&nbsp;
                                                                <?php
