                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" required class="form-control" disabled name="email" id="email" value="<?php echo set_value1('email', $info); ?>" placeholder="Email">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-default" name="edit_user">Edit Profile</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
