                  ...
                  <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                  ...
                                  <?php if((is_permission($this->session->userdata['role'], "add_business")) == TRUE){ ?>       
                                <a class="btn btn-green" style="float:right" href="<?php echo base_url();?>site/add_business">Add Business</a>
                                <?php } ?>
                                    ...
                                    <table class="table table-hover">
                                         <tr><td colspan="5" style="border-top: 0px solid #ddd;">&nbsp;</td></tr>
                                            <tr>
                                               ...
                                               <!--  <td style="width: 7%; vertical-align: middle;">&nbsp;&nbsp;Status :&nbsp;</td>
                                                ...
                                                <td>&nbsp;&nbsp;<button type="submit" name="go" value='filter' class="btn btn-default">GO</button> <a class="pull-right" href="<?php echo base_url(); ?>site/list_business">Reset Search</a></td>
                                            </tr>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;<button type="submit" name="filter" value="add_shop" class="btn btn-default">GO</button></td>
                                            </tr>
                                            <tr><td colspan="7" style="border-top: 1px solid #ddd;">&nbsp;</td></tr>
                                    </table>
                                    </form> 
                            ...
                            <div class="portlet-body">
                                <div class="table-responsive">
                                           ...
                                           <?php
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $v['contact_first_name'].' '.$v['last_name']; ?></td>
                                                             <td>
                                                                ...
                                                                <a href="<?php echo base_url(); ?>site/edit_business/?id=<?php echo $v['shop_id']; ?>"><img src="<?php echo base_url(); ?>assets/images/edit.png" /></a>&nbsp;
                                    ...
                                    <ul class="pagination pagination-sm">
                                            ...
                                            <li><a href="<?php echo base_url(); ?>site/list_business/?page_no=<?php echo $prev.$str; ?>">«</a></li>
                                            <?php
                                                for($i=$prev;$i<=$next;$i++){  
                                            ?>
                                            <li <?php if($curr_page==$i){echo 'class="active"';} ?>><a href="<?php echo base_url(); ?>site/list_business/?page_no=<?php echo $i.$str; ?>" <?php if($curr_page==$i){echo 'class="active"';} ?>><?php echo $i; ?></a></li>
                                            <?php 
                                                }
                                            ?>
                                            <li><a href="<?php echo base_url(); ?>site/list_business/?page_no=<?php echo $next.$str; ?>">»</a></li>
