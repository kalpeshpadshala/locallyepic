                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Business User List</li>
                            </ol>
                  ...
                  <div class="col-lg-12">
                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                ...
                                <a class="btn btn-green" style="float:right" href="<?php echo base_url();?>site/add_user">Add User</a>
                                <?php } ?>
                                    ...
                                    <table class="table table-hover">
                                         <tr><td colspan="5" style="border-top: 0px solid #ddd;">&nbsp;</td></tr>
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;<button type="submit" name="go" value='filter' class="btn btn-default">GO</button> <a class="pull-right" href="<?php echo base_url(); ?>site/list_user">Reset Search</a></td>
                                            </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $v['shop_name']; ?></td>
                                                             <td>
                                                                ...
                                                                <a href="<?php echo base_url(); ?>site/edit_user/?id=<?php echo $v['user_id']; ?>"><img src="<?php echo base_url(); ?>assets/images/edit.png" /></a>&nbsp;
