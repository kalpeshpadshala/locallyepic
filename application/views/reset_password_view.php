...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        ...
        <form role="form" method="post" action="<?php echo base_url(); ?>c_support/reset_password_submit">
            <input value="<?php echo $secret_token; ?>" type="hidden" name="secret_token" id="secret_token">
            <input value="<?php echo $ua; ?>" type="hidden" name="ua" id="ua">
            <hr class="colorgraph">
                      
            <div class="form-group">
                <input value="<?php echo set_value('new_password'); ?>" type="password" name="new_password" id="new_password" class="form-control input-lg" placeholder="Enter New Password" tabindex="3" required>
