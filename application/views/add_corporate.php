                            ...
                            <form method="POST" enctype="multipart/form-data" autocomplete="off">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-4">
                                            <select class="form-control" name="scat">
                                                ...
                                                foreach ($cats as $cat) {
                                                    ?>
                                                    <option value="<?php echo $cat['cid']; ?>" <?php if ($cat['cid'] == $sel_category) {
                                                        echo 'selected';
                                                    } ?>><?php echo $cat['cname']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <textarea rows="3" class="form-control"
                                                      name="sdesp"><?php echo set_value('sdesp'); ?></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" onFocus="geolocate()" autocomplete="off" name="sadd"
                                                   id="address" placeholder="" class="form-control input-textarea half"
                                                   value="<?php echo set_value('sadd'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" name="postal_code" id='postal_code' placeholder="" class="form-control"
                                                   value="<?php echo set_value('postal_code'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" name="burl" placeholder="" class="form-control"
                                                   value="<?php echo set_value('burl'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" name="sfname" placeholder="" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" name="slname" placeholder="" class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <input type="text" name="sphone" placeholder="" class="form-control"
                                                   value="<?php echo set_value('sphone'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-8">
                                            <button type="submit" name="add_corporate" class="btn btn-default">Submit
                                            </button>
                                        </td>
                                    </tr>
                                    </tbody>
