                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Add Ambassador</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
                                ...
                                <div class="portlet portlet-red">
                                    ...
                                    <div id="formControls" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>site/add_ambassador">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-default" name="add_ambassador">Add Ambassador</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
