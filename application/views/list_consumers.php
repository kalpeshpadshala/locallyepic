                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Consumers List</li>
                            </ol>
                                    ...
                                    <table class="table table-hover">
                                         <tr><td colspan="5" style="border-top: 0px solid #ddd;">&nbsp;</td></tr>
                                            <tr>
                                                ...
                                                <td style="width: 43%;"><input type="text" name="search" id="search" placeholder="search by name or email" <?php if(isset($search) && !empty($search)){ echo 'value="' . $search . '"';}?> class="form-control"></td>
                                                <td style="width: 6%; vertical-align: middle;">&nbsp;&nbsp;Per Page :&nbsp;</td>
                                                <td>
