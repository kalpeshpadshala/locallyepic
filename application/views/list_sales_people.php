            ...
            <div class="page-content">
                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">List Sales People</li>
                            </ol>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a class="btn btn-green" style="float:right" href="<?php echo base_url();?>site/add_sales_people">Add Sales People</a>
                        ...
                        <div class="portlet portlet-default">
                            ...
                            <div class="portlet-body">
                                <div class="table-responsive">
                                    <form action="<?php echo base_url(); ?>site/list_sales_people" method="GET" >  
                                    <table class="table table-hover">
                                         
                                            <tr>
                                                
                                                <td><input type="text" name="search" id="search" class="form-control" placeholder="Search by name or email"></td>
                                                ...
                                                <td><button type="submit" name="go" class="btn btn-default">GO</button> <a class="pull-right" href="<?php echo base_url(); ?>site/list_sales_people">Reset Search</a></td>
                                            </tr>
                                    </table>
                                    </form> 
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-responsive">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $city_name; ?></td>
                                                             ...
                                                             <td>
                                                                <a href="<?php echo base_url(); ?>site/edit_sales_people/?id=<?php echo $v['user_id']; ?>"><img src="<?php echo base_url(); ?>assets/images/edit.png" /></a>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <ul class="pagination pagination-sm">
                                            ...
                                            <li><a href="<?php echo base_url(); ?>site/edit_sales_people/?page_no=<?php echo $prev; ?>">«</a></li>
                                            <?php
                                                for($i=$prev;$i<=$next;$i++){  
                                            ?>
                                            <li <?php if($curr_page==$i){echo 'class="active"';} ?>><a href="<?php echo base_url(); ?>site/edit_sales_people/?page_no=<?php echo $i; ?>" <?php if($curr_page==$i){echo 'class="active"';} ?>><?php echo $i; ?></a></li>
                                            <?php 
                                                }
                                            ?>
                                            <li><a href="<?php echo base_url(); ?>site/edit_sales_people/?page_no=<?php echo $next; ?>">»</a></li>
