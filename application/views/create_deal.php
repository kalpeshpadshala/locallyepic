                     ...
                     <div class="portlet portlet-default">
                                    <div class="portlet-heading">
                                        <div class="portlet-title">
                                            <h4>How to Create an Offer Video Tutorial</h4>
                                        </div>
                                    ...
                                    <div id="formControls" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            <div id="englishcdv"><iframe width="560" height="315" src="https://www.youtube.com/embed/hqMRrNNYFzM?rel=0" frameborder="0" allowfullscreen></iframe></div>
                                            <div id="spanishcdv"></div>
                                        </div>
                                    </div>
                    </div>
                                    ...
                                    <div id="formControls" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            ...
                                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">  
                                                ...
                                                ?>
                                                    <input type="hidden" name="deal_image_dup" value="<?php echo $deal['barcode_image']; ?>">
                                                   
                                                    <div class="form-group">
                                                        <label for="barcode_image_view" class="col-sm-2 control-label">Barcode image</label>
                                                        <div class="col-sm-4">
                                                            <img id="barcode_image_view" src="<?php echo $deal['barcode_image'];?>" width="150" height="auto">
                                                    </div>
                                                    </div> 
                                                <?php
                                                }
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Offer Repeat</label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <span for="timepicker3" class="col-sm-2 control-label"> Offer Start Date  </span>
                                                            <div class="input-append bootstrap-timepicker input-group col-sm-2">
                                                        ...
                                                        <div class="form-group">
                                                            <span for="timepicker2" class="col-sm-2 control-label">Offer End Date  </span>
                                                            <div class="input-append bootstrap-timepicker input-group col-sm-2">
