...
<!-- Mirrored from beamcast.me/business/signin.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Dec 2014 04:15:14 GMT -->
<head>
...
#signup .inputs #submit:hover {
    ...
    <form id="reset_password" action="<?php  echo base_url();?>c_support/reset_password_submit/" method="POST">
        ...
        <div class="inputs">
            ...
            <br/><br/>
            <input name="new_password1" type="password" placeholder="Confirm new password"  />
            <br/>
