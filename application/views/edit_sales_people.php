                                ...
                                <div class="portlet portlet-red">
                                    ...
                                    <div id="formControls" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>site/edit_sales_people" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="birthday" placeholder="Birth Month-Date" value="<?php if(!empty($info['birthday'])){$date = explode("-",$info['birthday']); if(!empty($date)){echo $date[1]. "-" .$date[2];}} ?>" id='datetimepicker4' >
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="zip_code"  placeholder="Zip Code" class="form-control" value="<?php echo set_value1('zip_code', $info); ?>">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Area sales Manager :</label>
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="perent_id" id="perent_dropdown">
                                                            <option value="0">Select Perent</option>
                                                            <?php if(!empty($manager)){
                                                                    foreach ($manager as $managers) {?>
                                                                        <option value="<?php echo $managers['user_id']; ?>" <?php if($info['perent_id'] == $managers['user_id']){echo "selected";}?> ><?php echo $managers['first_name'] . " " . $managers['last_name']; ?></option>
                                                           <?php    }
                                                            }?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" class="btn btn-default" name="edit_sales_people">Edit Sales People</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
